module.exports = [
  {
    type: 4,
    data: {
      href: 'http://localhost:9528/#/traceability-system/index',
      width: 1163,
      height: 929
    },
    timestamp: 1642228465049
  },
  {
    type: 2,
    data: {
            ...
            childNodes: [
              {
                ...
                childNodes: [
                  ...
                  },
                  {
                    ...
                    attributes: {
                      rel: 'icon',
                      href: 'http://localhost:9528/favicon.ico'
                    },
                    childNodes: [],
                    id: 12
                  },
                  ...
                  },
                  {
                    ...
                    tagName: 'link',
                    attributes: {
                      href: 'http://localhost:9528/static/js/app.js',
                      rel: 'preload',
                      as: 'script'
                    },
                    childNodes: [],
                  ...
                  },
                  {
                    ...
                    tagName: 'link',
                    attributes: {
                      href: 'http://localhost:9528/static/js/chunk-vendors.js',
                      rel: 'preload',
                      as: 'script'
                    },
                    childNodes: [],
                    ...
                    childNodes: [
                      {
                        type: 3,
                        textContent:
                          '.global-module_status_text__3m4_5 {\n  font-size: 14px;\n  white-space: nowrap;\n  color: #c9cdd4;\n  cursor: default;\n  user-select: none;\n  margin: 0 8px;\n}\n\n.global-module_word-count__2EhXa {\n  margin-left: 0.8em;\n}\n',
                        isStyle: true,
                        id: 56
                      }
                    ],
                    ...
                    childNodes: [
                      {
                        type: 3,
                        textContent:
                          ".replayer-wrapper{position:relative}.replayer-mouse{position:absolute;width:20px;height:20px;-webkit-transition:left .05s linear,top .05s linear;transition:left .05s linear,top .05s linear;background-size:contain;background-position:50%;background-repeat:no-repeat;background-image:url(\"data:image/svg+xml;base64,\");border-color:transparent}.replayer-mouse:after{content:\"\";display:inline-block;width:20px;height:20px;background:#4950f6;border-radius:100%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%);opacity:.3}.replayer-mouse.active:after{-webkit-animation:click .2s ease-in-out 1;animation:click .2s ease-in-out 1}.replayer-mouse.touch-device{background-image:none;width:70px;height:70px;border-radius:100%;margin-left:-37px;margin-top:-37px;border:4px solid rgba(73,80,246,0);-webkit-transition:left 0s linear,top 0s linear,border-color .2s ease-in-out;transition:left 0s linear,top 0s linear,border-color .2s ease-in-out}.replayer-mouse.touch-device.touch-active{border-color:#4950f6;-webkit-transition:left .25s linear,top .25s linear,border-color .2s ease-in-out;transition:left .25s linear,top .25s linear,border-color .2s ease-in-out}.replayer-mouse.touch-device:after{opacity:0}.replayer-mouse.touch-device.active:after{-webkit-animation:touch-click .2s ease-in-out 1;animation:touch-click .2s ease-in-out 1}.replayer-mouse-tail{position:absolute;pointer-events:none}@-webkit-keyframes click{0%{opacity:.3;width:20px;height:20px}50%{opacity:.5;width:10px;height:10px}}@keyframes click{0%{opacity:.3;width:20px;height:20px}50%{opacity:.5;width:10px;height:10px}}@-webkit-keyframes touch-click{0%{opacity:0;width:20px;height:20px}50%{opacity:.5;width:10px;height:10px}}@keyframes touch-click{0%{opacity:0;width:20px;height:20px}50%{opacity:.5;width:10px;height:10px}}.rr-player{position:relative;background:white;float:left;border-radius:5px;-webkit-box-shadow:0 24px 48px rgba(17, 16, 62, 0.12);box-shadow:0 24px 48px rgba(17, 16, 62, 0.12)}.rr-player__frame{overflow:hidden}.replayer-wrapper{float:left;clear:both;-webkit-transform-origin:top left;transform-origin:top left;left:50%;top:50%}.replayer-wrapper>iframe{border:none}.rr-controller.svelte-19ke1iv.svelte-19ke1iv{width:100%;height:80px;background:#fff;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-ms-flex-pack:distribute;justify-content:space-around;-webkit-box-align:center;-ms-flex-align:center;align-items:center;border-radius:0 0 5px 5px}.rr-timeline.svelte-19ke1iv.svelte-19ke1iv{width:80%;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.rr-timeline__time.svelte-19ke1iv.svelte-19ke1iv{display:inline-block;width:100px;text-align:center;color:#11103e}.rr-progress.svelte-19ke1iv.svelte-19ke1iv{-webkit-box-flex:1;-ms-flex:1;flex:1;height:12px;background:#eee;position:relative;border-radius:3px;cursor:pointer;-webkit-box-sizing:border-box;box-sizing:border-box;border-top:solid 4px #fff;border-bottom:solid 4px #fff}.rr-progress.disabled.svelte-19ke1iv.svelte-19ke1iv{cursor:not-allowed}.rr-progress__step.svelte-19ke1iv.svelte-19ke1iv{height:100%;position:absolute;left:0;top:0;background:#e0e1fe}.rr-progress__handler.svelte-19ke1iv.svelte-19ke1iv{width:20px;height:20px;border-radius:10px;position:absolute;top:2px;-webkit-transform:translate(-50%, -50%);transform:translate(-50%, -50%);background:rgb(73, 80, 246)}.rr-controller__btns.svelte-19ke1iv.svelte-19ke1iv{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;font-size:13px}.rr-controller__btns.svelte-19ke1iv button.svelte-19ke1iv{width:32px;height:32px;display:-webkit-box;display:-ms-flexbox;display:flex;padding:0;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;background:none;border:none;border-radius:50%;cursor:pointer}.rr-controller__btns.svelte-19ke1iv button.svelte-19ke1iv:active{background:#e0e1fe}.rr-controller__btns.svelte-19ke1iv button.active.svelte-19ke1iv{color:#fff;background:rgb(73, 80, 246)}.rr-controller__btns.svelte-19ke1iv button.svelte-19ke1iv:disabled{cursor:not-allowed}.switch.svelte-9brlez.svelte-9brlez.svelte-9brlez{height:1em;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.switch.disabled.svelte-9brlez.svelte-9brlez.svelte-9brlez{opacity:0.5}.label.svelte-9brlez.svelte-9brlez.svelte-9brlez{margin:0 8px}.switch.svelte-9brlez input[type='checkbox'].svelte-9brlez.svelte-9brlez{position:absolute;opacity:0}.switch.svelte-9brlez label.svelte-9brlez.svelte-9brlez{width:2em;height:1em;position:relative;cursor:pointer;display:block}.switch.disabled.svelte-9brlez label.svelte-9brlez.svelte-9brlez{cursor:not-allowed}.switch.svelte-9brlez label.svelte-9brlez.svelte-9brlez:before{content:'';position:absolute;width:2em;height:1em;left:0.1em;-webkit-transition:background 0.1s ease;transition:background 0.1s ease;background:rgba(73, 80, 246, 0.5);border-radius:50px}.switch.svelte-9brlez label.svelte-9brlez.svelte-9brlez:after{content:'';position:absolute;width:1em;height:1em;border-radius:50px;left:0;-webkit-transition:all 0.2s ease;transition:all 0.2s ease;-webkit-box-shadow:0px 2px 5px 0px rgba(0, 0, 0, 0.3);box-shadow:0px 2px 5px 0px rgba(0, 0, 0, 0.3);background:#fcfff4;-webkit-animation:switch-off 0.2s ease-out;animation:switch-off 0.2s ease-out;z-index:2}.switch.svelte-9brlez input[type='checkbox'].svelte-9brlez:checked+label.svelte-9brlez:before{background:rgb(73, 80, 246)}.switch.svelte-9brlez input[type='checkbox'].svelte-9brlez:checked+label.svelte-9brlez:after{-webkit-animation:switch-on 0.2s ease-out;animation:switch-on 0.2s ease-out;left:1.1em}",
                        isStyle: true,
                        id: 58
                      }
                    ],
                ...
                childNodes: [
                                                ...
                                                childNodes: [
                                                  {
                                                    ...
                                                    tagName: 'a',
                                                    attributes: {
                                                      href: 'http://localhost:9528/#/dashboard',
                                                      class: ''
                                                    },
                                                    childNodes: [
                                                      {
                                                        ...
                                                        attributes: {
                                                          ...
                                                          style:
                                                            'padding-left: 20px; color: rgb(191, 203, 217); background-color: rgb(48, 65, 86);'
                                                        },
                                                        childNodes: [
                                                          {
                                                            type: 2,
                                                            ...
                                                            childNodes: [
                                                              {
                                                                ...
                                                                attributes: {
                                                                  'data-v-c8a70580':
                                                                    '',
                                                                  'xlink:href':
                                                                    'http://localhost:9528/#icon-dashboard'
                                                                },
                                                                childNodes: [],
                                                                isSVG: true,
                                                                id: 112
                                                    ...
                                                    childNodes: [
                                                      {
                                                        ...
                                                        attributes: {
                                                          ...
                                                          style:
                                                            'padding-left: 20px; color: rgb(64, 158, 255); background-color: rgb(48, 65, 86);'
                                                        },
                                                        childNodes: [
                                                          {
                                                            type: 2,
                                    ...
                                    childNodes: [
                                      ...
                                      },
                                      {
                                        ...
                                        attributes: {
                                          ...
                                          role: 'navigation',
                                          class:
                                            'el-breadcrumb app-breadcrumb breadcrumb-container'
                                        },
                                        childNodes: [
                                          {
                                            type: 2,
                  ...
                  },
                  {
                    ...
                    attributes: {
                      ...
                      src: 'http://localhost:9528/static/js/chunk-vendors.js'
                    },
                    childNodes: [],
                    id: 197
                  },
                  {
                    ...
                    attributes: {
                      type: 'text/javascript',
                      src: 'http://localhost:9528/static/js/app.js'
                    },
                    childNodes: [],
                    id: 198
                  },
      ...
      attributes: [
        {
          id: 98,
          attributes: {
            class: 'app-wrapper hideSidebar withoutAnimation mobile'
          }
        },
        {
          id: 269,
          attributes: {
            'aria-describedby': 'el-tooltip-1664',
            tabindex: '0'
          }
        },
        {
          id: 274,
          attributes: {
            'aria-describedby': 'el-tooltip-9706',
            tabindex: '0'
          }
        },
        {
      ...
      adds: [
        {
          ...
          node: {
            ...
            attributes: {
              role: 'menubar',
              class: 'el-menu--collapse el-menu',
        ...
        },
        {
          ...
          node: {
            ...
            attributes: {
              ...
              tabindex: '0',
              style:
                'position: absolute; left: 0px; top: 0px; height: 100%; width: 100%; display: inline-block; box-sizing: border-box; padding: 0px 20px;'
            },
            childNodes: [],
            id: 269
          }
        ...
        },
        {
          ...
          node: {
            ...
            attributes: {
              'data-v-c8a70580': '',
              'xlink:href': 'http://localhost:9528/#icon-dashboard'
            },
            childNodes: [],
            isSVG: true,
            id: 271
        ...
        },
        {
          ...
          node: {
            ...
            attributes: {
              role: 'menuitem',
              tabindex: '-1',
              class: 'el-menu-item is-active submenu-title-noDropdown',
              style:
                'padding-left: 20px; color: rgb(64, 158, 255); background-color: rgb(48, 65, 86);'
            },
            childNodes: [],
        ...
        },
        {
          ...
          node: {
            ...
            attributes: {
              'data-v-c8a70580': '',
              'xlink:href': 'http://localhost:9528/#icon-form'
            },
            childNodes: [],
            isSVG: true,
            id: 276
      ...
      attributes: [
        {
          id: 98,
          attributes: {
            class: 'app-wrapper hideSidebar withoutAnimation'
          }
        }
      ],
      removes: [],
