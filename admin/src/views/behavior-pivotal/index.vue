<template>
  <div class="app-container">
    ...
    <div class="content">
      <el-alert title="已关联业务相关ID的数据在关键行为分析列表展示！" show-icon type="info" :closable="false" />
      <el-table
      ...
      >
        ...
        <el-table-column label="业务说明" width="210" align="center">
          <template slot-scope="scope">{{ scope.row.business_info }}</template>
        </el-table-column>
